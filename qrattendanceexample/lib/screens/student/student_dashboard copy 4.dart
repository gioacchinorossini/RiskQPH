...
class _StudentDashboardState extends State<StudentDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    if (isTablet) {
      ...
      maxQrSize = (sliverAppBarHeight * 0.35).clamp(180, 300); // 35% of SliverAppBar height, between 180-300px
    } else {
    ...
    if (isTablet) {
      if (screenHeight > 1200) {
        ...
        startingTopPosition = (screenHeight * 0.50).clamp(200, 800);
      } else if (screenHeight > 800) {
        // Medium tablets (iPad Mini) - allow up to 600px  
        startingTopPosition = (screenHeight * 0.50).clamp(200, 600);
      } else {
      ...
      if (screenHeight > 800) {
        ...
        startingTopPosition = (screenHeight * 0.45).clamp(150, 400);
      } else {
        ...
        children: [
          ...
          Positioned(
            ...
            child: AnimatedContainer(
              ...
              height: qrSize,
              width: _scrollOffset > 200 ? screenWidth - (isTablet ? 160 : 80) : qrSize, // Expand to full width minus equal spacing (more spacing on tablets)
          ...
          // Floating Swipe Up Indicator (positioned above everything else)
          if (_scrollOffset < 10) ...[
            Positioned(
